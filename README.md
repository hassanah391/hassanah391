...
- 🏗️ Interested in clean architecture, CQRS, system design, and maintainable backend systems
- 🤖 Exploring RAG pipelines and LLM-powered backend features
...
AI-powered fashion platform — my ITI graduation project.  
Users can design custom clothing such as T-shirts, sneakers, pants, and caps using templates, uploads, and AI-generated suggestions.

`ASP.NET Core 9` `CQRS` `MediatR` `Angular` `JWT Auth` `Clean Architecture` `SQL Server`

> 📌 Want more? Check out [my pinned repos](https://github.com/hassanah391) below ⬇️
...
## 📫 Let's Connect
<p >
  <a href="mailto:hassan.ahmed3577@gmail.com">
